...
namespace ES_CRUD.BLL
{
    public class Customer
    {
        ...
        {
            _EsClientDAL.Current.DeleteIndex(new DeleteIndexRequest(DTO.Constants.DEFAULT_INDEX));
        }
        ...
        {
            var searchResults = _EsClientDAL.Current.Search<DTO.Customer>(s => s
                .From(0)
                .Size(10)
                 .Query(q => q
                 .Term(p => p.Id, id)
            ...
            //QueryContainer queryById = new TermQuery() { Field = "id", Value = id.Trim() };
            ...
            return searchResults as List<DTO.Customer>;
        }
        ...
        private IQueryContainer CreateSimpleQueryUsingAnd(DTO.Customer customer)
        {
            ...
            queryContainer &= new TermQuery() { Field = "id", Value = customer.Id };
